...
def doctor():
    ...
    # Top Frame
    top_frame = Label(Login, text='ورود پزشک',font = ('Cosmic', 20, 'bold'), bg='#3d90a0',relief='groove',padx=500, pady=10)
    ...
    def Search(arg = None):
        if username_entry.get() == '': 
            ...
            # Searching for users
            find_user = ('SELECT * FROM  Doctor_t WHERE docusername = ? AND docpassword = ?')
